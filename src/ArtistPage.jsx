...
Slim is featured along with Three 6 Mafia on 8Ball & MJG's second single "Cruzin'" off of their album Ridin High. </p> <p className={styles.p}>&emsp; Slim signed his a joint venture deal with Asylum/Atlantic with his M3 Productions Inc. and released his solo debut album Love's Crazy in November 2008. His first single was "So Fly", featuring Yung Joc and Shawty Lo.
In an interview with MiddleChildPromotions, Q. Parker confirmed that his debut album would be titled Real Talk and was due for release in September 2008. The album was later scheduled for release in 2009, however, the album never got released. He was in the studio working with Tim & Bob, The Pirates, Jammy, Bryan-Michael Cox, The Platinum Brothers and Crystal Johnson. The album was released under a joint venture between his own label, NewFam Entertainment, and Drift City Records. The first single off the album is called "Crazy Crazy" and it features Rock City.
...
On July 24, 2020, 112 released the single "Spend It All". In an interview with Rated R&B, they described the song as "an ode to women." "Spend It All" is the first single from 112's EP Forever, which they independently released on September 4. The band, as 2 members, embarked on the "Room 112 Tour" from November 2025 to February 2026 for the 30th anniversary of the group. 
      ...
      <ul>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_mOYTi65Igi0slL38hfEZCSoUkPlETw4ew" target="_blank">112 (1996)</a></li>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_lHO6reqKQ0BFrLtx81wMU8WYkkyNK9LyE" target="_blank">Room 112 (1998)</a></li>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_nsB1J22-FnzLR0y7z3np_Ze01cgXFvYjQ" target="_blank">Part III (2001)</a></li>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_k9zwA0BD2XgUi6849kKZT0YPB8Gx7vqFI" target="_blank">Hot & Wet (2003)</a></li>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_lUmR-8lArKqdvxIx2xXXnLYTzgi0aI_Mo" target="_blank">Pleasure & Pain (2005)</a></li>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_n0xskHN6l_bS56EG0OFg5Ex2BETFETe2Y" target="_blank">Q, Mike, Slim, Daron (2017)</a></li>
        <li><a href="https://music.youtube.com/playlist?list=OLAK5uy_mlEUAXzmvvdObHRly17D9v6TpJPPkB4pA" target="_blank">Forever (2020)</a></li>
      </ul>
    </>
  );
}